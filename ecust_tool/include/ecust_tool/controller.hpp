...
private:
	...
	ros::Publisher velocity_publisher_, attitude_publisher_, yawrate_publisher_,
			thrust_publisher_;
	...
	Controller():yaw_(0){
	    ...
	    if (control_mode == "attitude")
	    {
	      ...
	      joy_subscriber_ = node_handle_.subscribe<sensor_msgs::Joy>("joy", 1,
	                                                                 boost::bind(&Controller::joyAttitudeCallback, this, _1));
	    ...
	    else if (control_mode == "velocity")
	    {
	      ...
	      joy_subscriber_ = node_handle_.subscribe<sensor_msgs::Joy>("joy", 1,
	                                                                 boost::bind(&Controller::joyTwistCallback, this, _1));
	    ...
	    else if (control_mode == "position")
	    {
	      ...
	      joy_subscriber_ = node_handle_.subscribe<sensor_msgs::Joy>("joy", 1,
	                                                                 boost::bind(&Controller::joyPoseCallback, this, _1));
